...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  /** 认证成功实现 */
  @Autowired private AuthenticationSuccessImpl authenticationSuccess;

  /** 认证失败实现 */
  @Autowired private AuthenticationFailureImpl authenticationFailure;

  /** 加密方式 */
  @Autowired private BCryptPasswordEncoder bCryptPasswordEncoder;

  /** 认证用户自定义接口 */
  @Autowired private AuthenticationUserImpl authenticationUser;
  /**
